import{M as d}from"./MyProject-248cf98e.js";import{M as c}from"./MarkdownCell-a95f2c78.js";import{m as a,a9 as l,z as s,K as h,u as n,ai as p,A as u,C as f,B as o}from"./index-c1c3f66c.js";import"./tag-89837a44.js";const g=`## Introduction\r
\r
...
`,y=["src"],v=a({__name:"VideoCell",props:{src:{}},setup(t){const e=t,{src:r}=l(e);return(i,b)=>(s(),h("video",{src:n(r),controls:"",autoplay:"",loop:"",muted:""},null,8,y))}});const x=p(v,[["__scopeId","data-v-9d502a79"]]),w="/assets/activities-e72f3b60.png",k=a({__name:"CandiesVue",setup(t){const e={"activities.png":w};return(r,i)=>(s(),u(d,{project:"candies"},{default:f(()=>[o(x,{src:"https://github.com/xyqlx/xyqlx.github.io/assets/40012783/29eb14a5-6330-473c-96b5-5da5ae0b2316"}),o(c,{en:n(g),zh:n(m),urls:e},null,8,["en","zh"])]),_:1}))}});export{k as default};
